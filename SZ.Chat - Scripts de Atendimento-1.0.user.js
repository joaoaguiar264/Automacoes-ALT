    ...
    const SCRIPTS = {
        lentidao: {
            ...
            render: () => `
                ...
                <div class="szc-card">
                    <h3>Alterações realizadas no roteador</h3>
                    <div class="szc-check-list">
                        <div class="szc-check-item">
                ...
                <div class="szc-card">
                    <h3>Alterações realizadas na ONU</h3>
                    <div class="szc-check-list">
                        <div class="szc-check-item">
                ...
                <div class="szc-card">
                    <h3>Outras ações realizadas com o cliente</h3>
                    <div class="szc-check-list">
                        <div class="szc-check-item">
        ...
        conectado_sem_internet: {
            ...
            render: () => `
                ...
                <div class="szc-card">
                    <h3>Ações / Alterações realizadas no roteador</h3>
                    <div class="szc-check-list">
                        <div class="szc-check-item">
                            <label class="szc-check-header"><input type="checkbox" data-id="nenhumaAlt"><span>Nenhuma alteração realizada</span></label>
                        </div>
        ...
        troca_senha: {
            ...
            render: () => `
                ...
                <div class="szc-card">
                    <h3>Cliente entrou em contato solicitando</h3>
                    <div class="szc-check-list">
                ...
                <div class="szc-card">
                    <h3>Dados do roteador / ONU para documentação</h3>
                    <div class="szc-stack">
                        <div class="szc-field">
